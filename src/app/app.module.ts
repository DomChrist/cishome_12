...
import {ListsRoutingModule} from "./modules/lists/lists.routes";
import {WeatherOverviewComponent} from "./pages/dashboard/widgets/weather-overview/weather-overview.component";
import {FuelOverviewComponent} from "./pages/dashboard/widgets/fuel-overview/fuel-overview.component";
...
import {HomeControlModule} from "./modules/home-control/home-control.module";
...
@NgModule({
    imports: [
        ...
        WdysModule, SpinnerModule, ProgressSpinnerModule, WeekplanModule, HomeControlModule
    ],
    declarations: [
        AppComponent,
        AppMainComponent,
